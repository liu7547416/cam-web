import { _decorator, Animation, AnimationClip, Component, director, Node, tween, Vec3, AudioClip, AudioSource } from 'cc';
...
export class walk extends Component {
    ...
    walkJobRoomPath: action[] = [
        new action(405, -535, -0.2, 0.2),
        new action(176, -535, -0.2, 0.2),
    ...
    onAudioEnded(){
        ...
        if(this.kill_sound_play_count>3){
            ...
            console.error("回初始坐标：", this.node.position)
            return
        }
